...
export const articles = [
  { slug:"toc-nen-5-nhuom-nau-lanh-de-bi-anh-cam", title:"Vì sao tóc nền 5 nhuộm nâu lạnh dễ bị ánh cam?", category:"Kỹ thuật nhuộm", level:"Trung cấp", minutes:8, excerpt:"Phân tích sắc tố nền, ánh cam và nguyên tắc kiểm soát màu lạnh trên nền tóc Việt.", visual:"from-[#2d1d14] via-[#85613b] to-[#d7bd83]", imageKey:"article-toc-nen-5-anh-cam" },
  { slug:"tay-toc-an-toan-quy-trinh-5-buoc", title:"Tẩy tóc an toàn: Quy trình 5 bước đạt nền vàng chuẩn", category:"Tẩy & nâng nền", level:"Nâng cao", minutes:12, excerpt:"Cách kiểm soát nền, oxy, thời gian và phục hồi trong quá trình nâng sáng.", visual:"from-[#423324] via-[#c9a45c] to-[#f7f1e8]", imageKey:"article-tay-toc-an-toan" },
  { slug:"phu-bac-tu-nhien-cho-toc-bac-50-80", title:"Phủ bạc tự nhiên cho tóc bạc 50% - 80%", category:"Phủ bạc", level:"Trung cấp", minutes:7, excerpt:"Tư duy chọn nền, base tự nhiên và cách tránh sáng chân khi phủ bạc.", visual:"from-[#2d2924] via-[#78664b] to-[#d7d2c8]", imageKey:"article-phu-bac-tu-nhien" },
  { slug:"sua-loi-mau-khoi-bi-xanh-reu", title:"Sửa lỗi màu khói bị xanh rêu: nguyên nhân và xử lý", category:"Sửa lỗi màu", level:"Nâng cao", minutes:10, excerpt:"Các tình huống màu khói lệch rêu, tóc xốp hút màu và hướng cân bằng lại.", visual:"from-[#1a2420] via-[#637a4d] to-[#c9a45c]", imageKey:"article-sua-loi-mau-khoi-xanh-reu" }
];
