    ...
    <section className="px-4 py-12 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-8 lg:grid-cols-2 lg:gap-12">
          ...
          <div className="relative hidden overflow-hidden rounded-[2rem] border border-gold/20 bg-[#171410] p-4 shadow-gold/10 lg:block">
            <img
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {notebookItems.map((item) => {
              ...
              return (
                <div key={item.title} className="rounded-[1.75rem] border border-gold/15 bg-[#171410] p-5 text-white shadow-soft">
