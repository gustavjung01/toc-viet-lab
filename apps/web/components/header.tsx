    ...
    <header className="sticky top-0 z-50 border-b border-gold/10 bg-black/95 backdrop-blur">
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden items-center gap-3 md:flex">
          <PwaInstallButton
            compact
            className="inline-flex items-center gap-2 rounded-full border border-gold/30 px-4 py-2.5 text-sm font-extrabold text-gold transition hover:border-gold hover:bg-gold/10"
          />
        ...
        <>
          ...
          <nav className="absolute left-0 right-0 top-20 z-40 border-b border-gold/10 bg-black/95 px-4 py-4 sm:px-6 lg:hidden">
            <div className="space-y-2">
              ...
              <div className="pt-2">
                <PwaInstallButton
                  className="inline-flex w-full items-center justify-center gap-2 rounded-2xl border border-gold/35 bg-gold/10 px-4 py-3 text-sm font-extrabold text-gold transition hover:border-gold hover:bg-gold/15"
                />
              </div>
            </div>
          </nav>
