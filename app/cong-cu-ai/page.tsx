    ...
    <div className="bg-black text-cream-card">
      ...
      <main>
            ...
            <div className="grid gap-12 lg:grid-cols-[48%_52%] lg:items-center">
              <div className="space-y-8">
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                  <Link
                    href="/ai-tu-van-mau"
                    className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-[#D6A84F] px-8 py-4 text-lg font-extrabold text-[#030303] shadow-gold transition hover:bg-[#F0C76A] sm:w-auto"
                  >
                    Thử AI tư vấn màu
                    <ArrowRight size={20} />
                  </Link>
                  <Link
                    href="#tools"
                    className="inline-flex w-full items-center justify-center gap-2 rounded-full border border-gold/30 bg-[#171410] px-8 py-4 text-lg font-bold text-white transition hover:bg-[#201A13] sm:w-auto"
                  >
                    Xem bộ công cụ
                  </Link>
                </div>
                <div className="grid gap-3 sm:grid-cols-3">
                  {heroStats.map((stat) => (
                    <div key={stat} className="rounded-[1.75rem] border border-gold/20 bg-[#171410] p-4 text-sm text-white shadow-sm">
                      {stat}
                    </div>
                  ))}
                </div>
        ...
        <section className="px-4 py-20 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-[1240px] rounded-[2rem] border border-gold/20 bg-[#171410] p-8 shadow-soft">
            <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
              <div>
                ...
                <div className="mt-8 space-y-5 rounded-[2rem] border border-gold/20 bg-black/50 p-6">
                  <div className="rounded-3xl bg-[#201A13] p-5">
        ...
        <section className="bg-[#171410] px-4 py-20 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-[1240px] text-center">
            ...
            <div className="mt-12 grid gap-6 md:grid-cols-3">
              {[
                ...
                <div key={item.title} className="rounded-[2rem] bg-[#201A13] p-8 text-center">
